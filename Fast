...
\033[1;98m    ║✯ 𝖄𝖔𝖚𝖙𝖚𝖇𝖊   Devil Creations            ║  
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/ahtisham.sajid.Devil.prince302')
    else:
...
def pilih_super():
	...
	if peak =="":
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mɗℰҩ¡£ β❍ɣ ❸0❷\033[1;95m•◈•══════••◈•"
		try:
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91m🄳🄴🅅🄸🄻-🄱🄾🅈-302\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By 🄳🄴🅅🄸🄻-🄱🄾🅈-302--•◈•---»" #Dev:🇩​​​​​🇪​​​​​🇻​​​​​🇮​​​​​🇱​​​​​
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 Fast)↩\033[1;97m....'
